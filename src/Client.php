...
class Client
{
		...
		public function getLoginUri($casGuard, $redirect = null, $gateway = false, $renew = false)
		{
				...
				return $this->buildUri($this::$_ServerConfig->casBaseServerUri . self::$_ServerConfig->casGuard[$casGuard] . self::$_ServerConfig->casLoginUri, $params);
		}
		...
		{
				return $this->buildUri($this::$_ServerConfig->casBaseServerUri . self::$_ServerConfig->casGuard[$casGuard] . self::$_ServerConfig->casRegisterUri, [
						'service' => $this->getRedirectUri($casGuard, $redirect),
						'channel' => $this::$_ServerConfig->casChannel
				]);
		}
		...
		public function getLogoutUri($casGuard, $redirect = null)
		{
				...
				return $this->buildUri($this::$_ServerConfig->casBaseServerUri . self::$_ServerConfig->casGuard[$casGuard] . self::$_ServerConfig->casLogoutUri, [
						'service' => $this->getRedirectUri($casGuard, $redirect),
						'channel' => $this::$_ServerConfig->casChannel
				]);
		}
		...
		{
				return $this->buildUri($this::$_ServerConfig->casBaseServerUri . self::$_ServerConfig->casGuard[$this->casGuardName] . self::$_ServerConfig->casValidateUri, [
		...
		{
				return $this->buildUri($this::$_ServerConfig->casBaseServerUri . self::$_ServerConfig->casGuard[$this->casGuardName] . self::$_ServerConfig->casProxyValidateUri, [
						'service' => $this->getRequestUri()
				]);
		}
